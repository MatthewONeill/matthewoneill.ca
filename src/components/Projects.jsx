...
import onlineVideoPoker from '../images/projects/onlineVideoPoker.svg';
            ...
            <div style={{marginTop: "-16px"}}>
                ...
                <div class="row text-center align-items-center" id="projects">
                    <div class="col-md-6 nopadding" id="first">
                        <a href="https://github.com/MatthewONeill/cardMemoryGame"><img src={onlineVideoPoker} class="img-fluid w-100" alt=""></img></a>
                    </div>

                    <div class="col-md-6 nopadding" id="second">
                        <h2>Online Video Poker</h2>
                        <p>Tech Stack: TypeScript, React, Node.js, </p>
                        <hr class="mobileLine"></hr>
                        <p>Video Poker on the PC!</p>
